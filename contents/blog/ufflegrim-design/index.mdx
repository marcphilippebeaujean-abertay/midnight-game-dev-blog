---
title: Ufflegrim Roguelike Card Combat Design
date: 2020-04-29
template: post
image: ./image.png
banner: ./banner.png
...
**The roguelike genre has existed for a very long time. What made you pick it up for this title?**  
...
**Creatures have different types and synergies. Can you explain how you came up with these systems and some of the complications that arise as a result?**  
...
**There are many elements of randomness in the game, from drawing the cards to the level generation. How did you try to mitigate the importance of luck in your game, so that the player feels like they have more control?**  
...
**Each creature can be placed on a tile as an effect or summoned to follow the player around. Why did you choose to go down this route for the cards? How did you balance and design the two modes?**  
...
**Card games generally have resources or some other way to limit how the player can play their cards. In Ufflegrim, the player has to hit enemies to draw new cards. What was the design idea behind this mechanic? Did you try other things?**  
...
**“Deckfill” is a way to constrain the way that players create their decks. Each monster card has a deckfill value and if a deck does not have at least 100 points, you cannot play with it. What was the goal behind adding this constraint and how were the points assigned?**  
  
The idea is to limit cards that are too powerful. There is a big variance in the strength of different monsters, so as a penalty for adding some of the most powerful, the player needs to reduce the consistency of their deck by adding a lot of them (strong monsters generally have lower deckfill). On an interesting side note, deckfill is also tied to monsters spawn rate.
