...
category:
  - Guide
description: The creator of the action packed 2D roguelite racing game shares some of the lessons he learned from using the engine.
---

The solo developer of the title Blood Rally Show shares his experience moonlighting the game and the things he wished he had known before starting development. His game has recently launched on Steam!

<div stlye="display:block; width: 100%; max-width: 500px; margin: 0 auto;">
<iframe src="https://store.steampowered.com/widget/926860/" frameborder="0" width="100%" height="200"></iframe>
</div>


This guide is focused around getting the most from developing 2D games with the Unity3D engine and some things to consider as early as creating your project.
