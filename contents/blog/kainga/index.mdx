---
title: From no Game Dev Experience to launching a Steam Page
date: 2020-04-30
template: post
image: ./image.png
banner: ./banner.png
...
he went from having no practical game development experience and teaching himself everything from art to blueprint programming - he is also working a full time job and dedicating most of his free time to the game! Kainga is set to release on early access only a couple years later. 
<div stlye="display:block; width: 100%; max-width: 500px; margin: 0 auto;">
<iframe src="https://store.steampowered.com/widget/1269710/" frameborder="0" width="100%" height="200"></iframe>
</div>

**Can you tell us a bit about how you got into game development before working on Kainga?**  
  
Game development has been part of what I liked to do for a long time. I used to create maps for games like Morrowwind as a kid and took great enjoyment out of that. The reason I eventually moved onto 
...
procedurally generated, to keep things fresh each playthrough. One thing I had in early iterations was that when a certain disaster occurred, the thinker would come up with a solution based on their event or other factors 
like the environment around the village. This really streamlined many player decisions, so I took it out.  
  
**There are many types of strategy games, some that focus on macro management, resource management and general numbers crunching (like the Civilization series). Others have the player making small scale decisions like moving units around, that require quicker reactions. Where does Kainga fall on this scale?**  
  
It's definitely more on the Age of Empires esque "micromanagement" side of things in that regard. I actually am not a very big fan of games that require heavy UI and menus, so my initial goal was to have absolutely no HUD! 
...
For example, I wanted to give the player's villagers a sense of insignificance by creating huge fantasy beasts that tower over them (these can actually be tamed and buildings built on top of them). The issue was that these simply 
did not look good as 2D sprites, so I ended up learning 3D as well! I started with Blender and taught myself primarily through YouTube courses. It's incredible how you can learn pretty much everything online these days.  
...
I'm also working on raising more exposure for the game. I've been trying to focus more on social media, posting on Reddit and doing guest content for various blogs. I also have generated an email list of press that could be interested in featuring the game.  
