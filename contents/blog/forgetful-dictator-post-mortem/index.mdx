---
title: Forgetful Dictator - Educational Game Post Mortem
date: 2020-04-29
template: blog
image: ./image.png
banner: ./banner.png
description: Developer of a game that teaches geography shares how he developed it without having any technical skills.
---
...
<iframe src="https://store.steampowered.com/widget/1087810/" frameborder="0" width="100%" height="200"></iframe></div>
...
The most important asset however was the World Map Strategy Kit. It was the base for my game. Thanks to that asset, even though I'm not a good programmer I found that adding new features didn't take too long. The biggest single time sink in an educational game like this is the research- I spent months writing trivia questions.
...
<Profile name="Please Know More" image={"/images/profile_images/pkm_logo.png"} promoLinks={[{
            name: "Twitter",
