...
giving you an overview of how to fund your game and the different paths you can take when trying to raise money for your next
project.
...
Publishers are easier to work with when you are releasing a game that only requires customers to make a one-of purchase (also known as the “premium” revenue model),
 because if the collaboration doesn’t work out you can always go your separate ways after the game is released. In addition, this makes it easier for the publisher to calculate the time frame for which they have to provide 
...
Once you’ve identified a list of potential publishers, the best way to reach them is by having connections with someone on the publishing  
team or writing a cold email that is personalised and gives a brief overview of your game idea. Make sure to focus on the things 
