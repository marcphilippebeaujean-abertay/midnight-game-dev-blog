---
title: Vector Maths for Game Dev Beginners
date: 2020-05-19
template: post
category:
    - Guide
image: ./image.jpg
description: Learn some of the common operations that are used for implementing automated turrets, AI field of vision, projectiles, and many more.
---
import GameMathsBook from "../../../src/components/products/amazon/games-maths-book.js"
...
Mastering how to work with vectors in game engines is one of the core building blocks to becoming a great games programmer and gives you the ability to implement most of the mechanics found in modern games. This guide will start form scratch and teach you the fundamentals, as well as some of the less intuitive operations and features of vector that can help you implement some more advanced game mechanics. It will also feature some Unity3D code examples, but focuses on explaining concepts in a way where they will allow you to implement them regardless of what tool you are using.
...
## Conclusion
I hoped you enjoyed this short introduction to what you can do with vectors for game development! There are still a lot more things that I could cover (projections, interpolation, etc.), so please leave a comment if you would want to learn more. I can also highly recommend this book that I read while studying, it taught me a lot about games maths and goes deeper into the underlying concepts than this article.  
<GameMathsBook />