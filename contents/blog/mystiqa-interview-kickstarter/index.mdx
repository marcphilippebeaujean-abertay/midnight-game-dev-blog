---
title: Getting a Game funded as a fulltime Student
date: 2020-04-29
template: post
image: ./image.png
banner: ./banner.png
...
---
import MystiqaSteam from "../../../src/components/products/steam/mystiqa.js"
...
### How did you refine your Game's Design? ###
...
### What were some of the Tools that you used to create the Game? ###
...
### Your game recently got some Funding via Kickstarter. Can you give us a quick overview of the current State? ###
...
### What was your Motivation for going on Kickstarter? ###
...
### How did you come up with the funding Perks? ###
...
### How did you balance University and Game Development? ###
...
### What have you learned from the Development of your Game? ###

I've been developing Mystiqa for 3 years - one of the biggest lessons was the importance of graphics and listening to player feedback. 14 days into the Kickstarter campaign (so pretty much halfway), I drastically changed the displayed art on the website after receiving some feedback on reddit.
