...
Mystiqa is an action RPG developed by a first year computer science student. In this interview, he shares how he designed and created his game, as well as some of the things that he learend from launching a successful Kickstarter campaign. His game is set to release on Steam Early Access this September.
...
<Profile name="Julian Creutz" image={"/images/profile_images/julien-creutz.png"} promoLinks={[{
            name: "Twitter",
