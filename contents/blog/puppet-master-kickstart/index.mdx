---
title: Analyzing Kickstarter Failure with Data
date: 2020-04-29
template: post
image: ./image.png
banner: ./banner.jpg
category:
  ...
  - Funding
  - Marketing
description: Rafael Vazquez shares the data from his failed Kickstarter Campaign for his latest game Puppet Master.
externals_profile:
    image: ./author.jpg
    name: Rafael Vazquez
    rounded: True
    links:
        ...
        - name: Steam
          ...
          url: https://store.steampowered.com/search/?developer=Chupacabra%20Game%20Studios
        - name: Discord
          icon: /images/Discord.svg
          url: https://discordapp.com/invite/tRavAjY
---
import PuppetMaster from "../../../src/components/products/steam/puppet-master.js"
