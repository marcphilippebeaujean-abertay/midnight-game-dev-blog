...
externals_profile:
    ...
    links:
        ...
        - name: Linkedin
          ...
          url: https://www.linkedin.com/in/martin-vu-39310416a/
        - name: Website
          icon: /images/Website.svg
          url: https://amanotes.com/
---

One of the most frequently asked questions about the mobile game market is how
...
mobile game industry had $49 billion in revenue and $16.9 billion in profits, which takes
up 60% of the total gaming industry’s revenue! So how are the games doing it when most
of the games are free? And which models is the best one for your game? Let’s find out.
...
Between a specific number of levels, you can put in interstitial ads. These are
short video ads that either run for only about 5 seconds, or are skippable after a short amount of time.
These are mandatory for the user to watch, and are usually placed between game levels,
or transitions between menus.

Since they are so short, and most of the revenue you get is from click throughs and
...
to get some revenue across, with the only price to pay being lower retention and game ratings from frustrated players.
...
Since they require a short gameplay loop to stack effectively, this monetization model is
...
The user would voluntarily watch a rewarded ad in exchange for in-game goods such as
...
In contrast of interstitial ads, the player not only chooses to watch an ad themselves, they
get something in return, be it a time saver or a neat in-game item. This reduces the chance that the player
will become upset while playing your game, even though they have to watch longer ads.
...
the game’s economy in mind. Creating an economy where the player gets a lot of value
just by watching ads over and over again would break it. On the other hand, creating an economy
...
Another thing to keep in mind is that even though the revenue you receive from rewarded
ads is higher than interstitials, it is way harder to have players watch them. While with
...
Another well known monetization technique, which is slowly appearing in more and more
...
Games like this get most of their revenue from "sharks", "dolphins" and "whales" - phrases for users that
...
If your game is of higher quality and perhaps initially intended for the premium model,
this might be a good fit for you. Your game will face less competition than in the general store, it will get featured by the 
stores (App Store or Google Play) more often and you don’t really have to worry much about marketing, as Apple and
Google are doing that for you.
