---
title: Woodle Tree 2 Interview with Chubby Pixel
date: 2020-04-29
template: blog
image: ./image.png
banner: ./banner.jpg
...
Woodle Tree 2 is a 3D platformer that is reminiscent of the classic platformers that emerged on consoles like the N64. In this interview, programmer Fabio Ferrara from Chubby Pixel discusses the inspiration behind the design of the game, as well as some of the performance challenges his team had to overcome. 
...
We never had a publisher for our games, since we would like to remain 100% independent. This gives you a lot more freedom, but surely has its negative aspects: if you fail, that is always that risk that you'll not be able to develop your next game.

**What parts of the development went well, what parts would you have done differently given what you know now?**

I have to say that I didn't know at the beginning how the game would become and if it was able to go on Nintendo Switch. But in the end I'm really proud of the game: the only thing I would have done differently was to add a lot more content before releasing it!

<Profile name="Chubby Pixel" image={"/images/profile_images/chubby-pixel.png"} promoLinks={[{
            name: "Twitter",
        ...
        }, 
        {
            ...
            url: "https://www.youtube.com/user/MalboM"
        },
        {
