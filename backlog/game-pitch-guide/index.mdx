...
their game with mentors for 3 months. After that time period, they would be heading to one of the biggest
games conferences in Europe to show it off and find out if they were the overall winners. The
...
Try to keep the actual idea breakdown very concise, think about how you can convey the idea using
...
you should go into extra detail. You should have data proving to the investor that you are in a
market where there are a lot potential players and there is room for another game to be successful.
...
game idea. It’s a great idea to let the investors play the game if they want to, so make sure you have
...
you are proposing, as opposed to another before?
...
interest for them. A few years later, with the recent announcement of several triple A companies
revisiting the old school platformer genre, it’s safe to say that we were on to something with our
claims!
...
This is something I am still mad about today, but ultimately don’t want to blame anyone for because
it was really my responsibility that this ended up going badly. I remember sitting in the universities
computer lab with a team member, trying to figure out the mathematics needed to get the player to
run around the globe (a basic Unity sphere at the time). It felt amazing when we finally made it
and we were sure that if we showed this to the judges, their jaws would crack the floor boards!
...
### Not highlighting the teams skills

Our team was very good and full of talented people. It would have been easy to boast about our
achievements and also make the case that many of us had worked on projects together in the past.
We decided to take a humble approach in the pitch, which is definitely not the right thing to do.
